...
import iMongodb from './media/mongodb.boxed.svg'
import iNode from './media/nodejs.boxed.svg'
import iReact from './media/react.boxed.svg'
  ...
  return (
      <div>
        ...
        <Grid container xs={12} direction='row' spacing={16}>
          <Grid item xs={6} md={3} className={classes.item} alignContent='stretch'>
            <Paper className={classes.paper} elevation={0}>
              <ResponsiveImage src={iMongodb} className={classes.logo} alt='mongo db' />
            </Paper>
          </Grid>
          <Grid item xs={6} md={3} className={classes.item} alignItems='center'>
            <Paper className={classes.paper} elevation={0}>
